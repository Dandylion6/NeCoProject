 ...
 * <c>attractionReduction</c> rate and <c>powerConsumption</c>.
 * 
 * Usage example:
 * 
 * @code
...
struct Machine final
{
	...
	/**
	 * @brief Power consumption in watts while machine is powered and active.
	 */
	...
	constexpr Machine(const float attractionReduction, const uint16_t powerUsage) noexcept
