 ...
 * registry.emplace<Component::ShotAudio>(entity, gunshotSound);
 * @endcode
 */
struct ShotAudio final
{
    // ------ Members ------
    ...
    constexpr ShotAudio() noexcept = default;
    explicit constexpr ShotAudio(const Sound& sound) noexcept : sound(sound) {}
};


/**
 * @brief Component that allows an entity to hold looping sound or music.
 *
 ...
 *
 * Like <c>ShotAudio</c>, the sound should be preloaded or obtained from a
