...
#include "components/ui/save_menu_tag.hpp"
...
namespace Construct
{
	static const entt::entity SaveBackdropEntity(
	...
	)
	{
		...
		registry.emplace<Tag::SaveMenu>(entity);
...
const entt::entity Construct::SaveMenuBackgroundEntity(
	entt::registry& registry, ResourceStore& resourceStore, Nc::Vector2f windowSize
)
{
	Construct::SaveBackdropEntity(registry, windowSize);
