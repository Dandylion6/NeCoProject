...
LabelButton Construct::RestartButton(entt::registry& registry, ResourceStore& resourceStore, GameState& gameState)
{
    ...
    return Construct::LabelButtonObject<Tag::RestartMenu>(std::move(transform), "RESTART FROM SAVE", std::move(toMainMenu), registry, resourceStore);
}
...
LabelButton Construct::RestartToMainButton(entt::registry& registry, ResourceStore& resourceStore, GameState& gameState)
{
    ...
    return Construct::LabelButtonObject<Tag::RestartMenu>(std::move(transform), "TO MAIN MENU", std::move(toMainMenu), registry, resourceStore);
}
