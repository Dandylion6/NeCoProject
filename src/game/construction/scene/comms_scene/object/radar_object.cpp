...
) noexcept
{
	...
	Component::Transform& transform = registry.emplace<Component::Transform>(
		entity, RadarScene, Nc::Vector2f::Zero(), size
	);
	registry.emplace<Component::Sprite>(entity, std::move(texture));
...
const entt::entity Object::Radar::Artillery::Create(
	entt::registry& registry, Nc::ResourceStore& resourceStore
) noexcept
{
	const entt::entity entity = registry.create();
...
const entt::entity Object::Radar::ErrorWarning::Create(
	entt::registry& registry
) noexcept
{
...
const entt::entity Object::Radar::RecalibrationText::Create(
	entt::registry& registry
) noexcept
{
	...
	Component::Text& text = registry.emplace<Component::Text>(
		entity, "RECALIBRATING", Palette::RADAR_COLOR, Nc::Font::WDXL, Nc::Font::Size::Small, Alignment::Center
	);
