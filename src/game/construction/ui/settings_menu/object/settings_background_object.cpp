...
void Object::SettingsBackground::Create(const SceneContext& context, const Nc::Vector2f windowSize) noexcept
{
...
entt::entity Object::SettingsBackground::FrontTexture::Create(const SceneContext& context) noexcept
{
    constexpr char BACKGROUND_PATH[] = "assets/environment/backgrounds/main_menu.png";
	...
	context.registry.emplace<Component::Sprite>(entity, texture, 0.4f);

	context.registry.emplace<Component::Action::Input>(entity, KEY_ESCAPE, false);
