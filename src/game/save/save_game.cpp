...
static Result SaveGameState(const GameState& gameState, nlohmann::json& data)
{
...
static Result LoadGameState(GameState& gameState, nlohmann::json& data)
{
